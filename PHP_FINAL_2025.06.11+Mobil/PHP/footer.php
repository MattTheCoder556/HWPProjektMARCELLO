...
<footer class="py-5" style="background-color: #2E2E3A; color: #BBB8B2;">
    <div class="container">
        <div class="row align-items-start">
            <!-- Logo Column -->
            <div class="col-12 col-md-3 mb-4 d-flex justify-content-center justify-content-md-start">
                <a href="index.php" target="_self" aria-description="Link to indexpage">
                    <img src="../assets/pictures/logo.png" alt="Logo" style="max-width: 120px;">
                </a>
            </div>
            ...
            {
                echo '<li><a href="https://mmm.stud.vts.su.ac.rs/PHP/register.php" class="footer-link">Register</a></li>';
                echo '<li><a href="https://mmm.stud.vts.su.ac.rs/PHP/login.php" class="footer-link">Login</a></li>';
            }
            ?>
        </ul>
    </div>
    ...
    <div class="col-12 col-md-4 mb-4">
            ...
            ?>
            <li><a href="https://mmm.stud.vts.su.ac.rs/PHP/availableEvents.php" class="footer-link">Available Events</a></li>
        </ul>
    </div>
    ...
    <div class="col-12 col-md-4 mb-4">
                        ...
                        <ul class="list-unstyled">
            <li><a href="https://mmm.stud.vts.su.ac.rs/PHP/contact.php" class="footer-link">Contact</a></li>
            <li><a href="https://mmm.stud.vts.su.ac.rs/PHP/faq.php" class="footer-link">FAQ</a></li>
        </ul>
    </div>
</div>
</div>
...
<hr class="my-4" style="border-color: #BBB8B2;">
        <div class="text-center">
            <img src="https://mmm.stud.vts.su.ac.rs/assets/pictures/logo.png" alt="Logo" style="max-width: 50px;" class="mb-2">
